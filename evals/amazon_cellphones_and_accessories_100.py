...
class AmazonCellPhonesAndAccessories100(BaseEval):
    ...
    def eval_type(self) -> BitrecsEvaluationType:
        return BitrecsEvaluationType.AMAZON_CELL_PHONES_AND_ACCESSORIES_100
