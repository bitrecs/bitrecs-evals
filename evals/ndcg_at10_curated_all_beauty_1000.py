...
class NdcgAt10CuratedAllBeauty1000(BaseEval):
    def __init__(self, run_id: str, miner_artifact: Artifact = None):
        super().__init__(run_id, miner_artifact)
        
        dataset_url = "https://huggingface.co/datasets/reallybigmouse4/ndgc_amazon_curated/resolve/main/All_Beauty/amazon_curated_all_beauty_universe_1000.csv"
    ...
    def eval_type(self) -> BitrecsEvaluationType:
        return BitrecsEvaluationType.NDCG_AT10_CURATED_ALL_BEAUTY_1000
