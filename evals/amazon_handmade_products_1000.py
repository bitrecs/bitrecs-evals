...
class AmazonHandmadeProducts1000(BaseEval):
    ...
    def eval_type(self) -> BitrecsEvaluationType:
        return BitrecsEvaluationType.AMAZON_HANDMADE_PRODUCTS_1000   
