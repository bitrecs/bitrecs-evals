...
class NdcgAt10CuratedAmazonFashion100(BaseEval):
    def __init__(self, run_id: str, miner_artifact: Artifact = None):
        super().__init__(run_id, miner_artifact)
        
        dataset_url = "https://huggingface.co/datasets/reallybigmouse4/ndgc_amazon_curated/resolve/main/Amazon_Fashion/amazon_curated_amazon_fashion_universe_100.csv"
    ...
    def eval_type(self) -> BitrecsEvaluationType:
        return BitrecsEvaluationType.NDCG_AT10_CURATED_AMAZON_FASHION_100
