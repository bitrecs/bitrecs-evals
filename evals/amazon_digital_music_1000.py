...
class AmazonDigitalMusic1000(BaseEval):
    ...
    def eval_type(self) -> BitrecsEvaluationType:
        return BitrecsEvaluationType.AMAZON_DIGITAL_MUSIC_1000   
