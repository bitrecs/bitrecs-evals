...
class NdcgAt10CuratedMusicalInstruments1000(BaseEval):
    def __init__(self, run_id: str, miner_artifact: Artifact = None):
        super().__init__(run_id, miner_artifact)
        
        dataset_url = "https://huggingface.co/datasets/reallybigmouse4/ndgc_amazon_curated/resolve/main/Musical_Instruments/amazon_curated_musical_instruments_universe_1000.csv"
    ...
    def eval_type(self) -> BitrecsEvaluationType:
        return BitrecsEvaluationType.NDCG_AT10_CURATED_MUSICAL_INSTRUMENTS_1000
