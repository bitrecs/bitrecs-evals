...
class AmazonToolsAndHomeImprovement500(BaseEval):
    ...
    def eval_type(self) -> BitrecsEvaluationType:
        return BitrecsEvaluationType.AMAZON_TOOLS_AND_HOME_IMPROVEMENT_500   
