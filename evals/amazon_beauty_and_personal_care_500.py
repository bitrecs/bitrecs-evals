...
class AmazonBeautyAndPersonalCare500(BaseEval):
    ...
    def eval_type(self) -> BitrecsEvaluationType:
        return BitrecsEvaluationType.AMAZON_BEAUTY_AND_PERSONAL_CARE_500   
