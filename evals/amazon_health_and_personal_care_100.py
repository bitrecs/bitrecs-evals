...
class AmazonHealthAndPersonalCare100(BaseEval):
    ...
    def eval_type(self) -> BitrecsEvaluationType:
        return BitrecsEvaluationType.AMAZON_HEALTH_AND_PERSONAL_CARE_100   
