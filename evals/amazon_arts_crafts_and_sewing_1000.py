...
class AmazonArtsCraftsAndSewing1000(BaseEval):
    ...
    def eval_type(self) -> BitrecsEvaluationType:
        return BitrecsEvaluationType.AMAZON_ARTS_CRAFTS_AND_SEWING_1000   
