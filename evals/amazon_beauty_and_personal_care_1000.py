...
class AmazonBeautyAndPersonalCare1000(BaseEval):
    ...
    def eval_type(self) -> BitrecsEvaluationType:
        return BitrecsEvaluationType.AMAZON_BEAUTY_AND_PERSONAL_CARE_1000   
