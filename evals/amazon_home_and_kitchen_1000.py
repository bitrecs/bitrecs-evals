...
class AmazonHomeAndKitchen1000(BaseEval):
    ...
    def eval_type(self) -> BitrecsEvaluationType:
        return BitrecsEvaluationType.AMAZON_HOME_AND_KITCHEN_1000   
