...
class AmazonAllBeautyNDCG(BaseEval):
    def __init__(self, run_id: str, miner_artifact: Artifact = None):
        ...
        logger.info(f"Loaded All_Beauty_100 holdout set with {len(self.holdout_df)} records.")
    ...
    def eval_type(self) -> BitrecsEvaluationType:
        return BitrecsEvaluationType.AMAZON_ALL_BEAUTY_100
...
if __name__ == "__main__":
    ...
    eval_instance = AmazonAllBeautyNDCG(run_id="test_run", miner_artifact=mock_artifact)
