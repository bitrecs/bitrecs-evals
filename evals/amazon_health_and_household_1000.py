...
class AmazonHealthAndHousehold1000(BaseEval):
    ...
    def eval_type(self) -> BitrecsEvaluationType:
        return BitrecsEvaluationType.AMAZON_HEALTH_AND_HOUSEHOLD_1000   
