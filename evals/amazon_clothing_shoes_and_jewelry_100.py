...
class AmazonClothingShoesAndJewelry100(BaseEval):
    ...
    def eval_type(self) -> BitrecsEvaluationType:
        return BitrecsEvaluationType.AMAZON_CLOTHING_SHOES_AND_JEWELRY_100
