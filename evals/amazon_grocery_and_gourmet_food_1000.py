...
class AmazonGroceryAndGourmetFood1000(BaseEval):
    ...
    def eval_type(self) -> BitrecsEvaluationType:
        return BitrecsEvaluationType.AMAZON_GROCERY_AND_GOURMET_FOOD_1000   
