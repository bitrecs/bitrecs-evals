...
class AmazonHealthAndPersonalCare1000(BaseEval):
    ...
    def eval_type(self) -> BitrecsEvaluationType:
        return BitrecsEvaluationType.AMAZON_HEALTH_AND_PERSONAL_CARE_1000   
