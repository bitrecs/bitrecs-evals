...
class AmazonIndustrialAndScientific500(BaseEval):
    ...
    def eval_type(self) -> BitrecsEvaluationType:
        return BitrecsEvaluationType.AMAZON_INDUSTRIAL_AND_SCIENTIFIC_500   
