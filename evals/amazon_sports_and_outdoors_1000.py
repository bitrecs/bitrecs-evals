...
class AmazonSportsAndOutdoors1000(BaseEval):
    ...
    def eval_type(self) -> BitrecsEvaluationType:
        return BitrecsEvaluationType.AMAZON_SPORTS_AND_OUTDOORS_1000   
