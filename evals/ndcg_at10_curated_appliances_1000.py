...
class NdcgAt10CuratedAppliances1000(BaseEval):
    def __init__(self, run_id: str, miner_artifact: Artifact = None):
        super().__init__(run_id, miner_artifact)
        
        dataset_url = "https://huggingface.co/datasets/reallybigmouse4/ndgc_amazon_curated/resolve/main/Appliances/amazon_curated_appliances_universe_1000.csv"
    ...
    def eval_type(self) -> BitrecsEvaluationType:
        return BitrecsEvaluationType.NDCG_AT10_CURATED_APPLIANCES_1000
