...
class AmazonCellPhonesAndAccessories1000(BaseEval):
    ...
    def eval_type(self) -> BitrecsEvaluationType:
        return BitrecsEvaluationType.AMAZON_CELL_PHONES_AND_ACCESSORIES_1000
