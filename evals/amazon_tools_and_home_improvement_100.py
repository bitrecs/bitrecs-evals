...
class AmazonToolsAndHomeImprovement100(BaseEval):
    ...
    def eval_type(self) -> BitrecsEvaluationType:
        return BitrecsEvaluationType.AMAZON_TOOLS_AND_HOME_IMPROVEMENT_100   
